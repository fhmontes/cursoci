...
<html lang="en">
  <head>
    ...
    <title><?php echo isset($title)?$title:'CURSO CODEIGNITER'; ?></title>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><?php echo isset($title)?$title:'CURSO CODEIGNITER'; ?></h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#"><?php echo isset($title)?$title:'CURSO CODEIGNITER'; ?></a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
